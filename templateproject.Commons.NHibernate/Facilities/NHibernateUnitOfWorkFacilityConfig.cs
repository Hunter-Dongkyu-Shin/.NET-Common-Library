...
namespace templateproject.Commons.Facilities
{
    public class NHibernateUnitOfWorkFacilityConfig
    {
        private Iesi.Collections.Generic.ISet<Assembly> assemblies = new HashedSet<Assembly>();
        private Iesi.Collections.Generic.ISet<Type> entities = new HashedSet<Type>();
